...
def handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    """
    Lambda function to get all users by organization ID from DynamoDB.
    ...
    try:
        ...
        users, get_error = get_users_by_org_id_from_db(org_id, table_name)
        if get_error:
            return get_error

        # Return success response
        return create_users_list_response(users)
