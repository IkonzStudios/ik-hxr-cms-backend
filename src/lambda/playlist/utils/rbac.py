...
# RBAC Permission Matrix for Playlist resources
PERMISSIONS = {
    "superadmin": {
        "playlist": ["create", "edit", "delete", "view"]
    },
    "admin": {  # ORG ADMIN - can manage playlists within their organization
        "playlist": ["create", "edit", "delete", "view"]
    },
    "content_admin": {
        # No playlist permissions
    },
    "analytics_user": {
        # No playlist permissions
    },
